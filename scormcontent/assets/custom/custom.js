...
$(document).ready(function() {
  ...
  $('#app').on('DOMNodeInserted', function(e) {
    ...
    // $('#app .blocks-lesson select').each(function(){
...
var questionObj = {
  "Self-Assessment":1,
  "Re-rank your proficiency":1,
  "Networking":5,
  "Preparation":3,
  "Your 3 strongest competencies":3,
  "Daniel's therapy journey-Part I":6,
  "Daniel's therapy journey-Part II":4,
  "Daniel's therapy journey-Part III":4,
  "Scenario summary and reflection":2,
  "Practical strategies you can use in your role":3,
  "Competencies to further develop":10
}
for (key in questionObj) { 
  for (let keyIndex = 0; keyIndex < questionObj[key]; keyIndex++) {    
    prompt = key+"_"+keyIndex;
    setLMSData(objid, response, prompt); 
...
window.addEventListener("hashchange", function(){
  ...
  if(pageTitle == "Rank your proficiency" || pageTitle == "Re-rank your proficiency") {
    pageNum = 3;
  }else if(pageTitle == "Networking" || pageTitle == "Preparation") {
    pageNum = 4;
  }else if(pageTitle == "Daniel's therapy journey-Part I") {
    pageNum = 9;
  }else if(pageTitle == "Daniel's therapy journey-Part II") {
    pageNum = 10;
  }else if(pageTitle == "Daniel's therapy journey-Part III") {
    pageNum = 11;
  }else if(pageTitle == "Scenario summary and reflection") {
    pageNum = 12;
  }else if(pageTitle == "New or enhanced strategies" || pageTitle == "Competencies to further develop") {
    pageNum = 13;
  } else {
    pageNum = 1;
  }
